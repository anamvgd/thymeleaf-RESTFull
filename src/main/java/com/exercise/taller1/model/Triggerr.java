...
public class Triggerr implements Serializable {
	...
	@NotNull(groups = {TriggerrAddValidation.class, TriggerrEditValidation.class})
	@Size(min = 5, max = 30, groups = { TriggerrAddValidation.class, TriggerrEditValidation.class })
	private String trigName;

	@Column(name="TRIG_SCOPE")
	@NotNull(groups = {TriggerrAddValidation.class, TriggerrEditValidation.class})
	@Size(min = 5, max = 15, groups = { TriggerrAddValidation.class, TriggerrEditValidation.class })
